...
<html>
  ...
  <body>
    <!-- Menu -->
    <div id="wrapper"  style="background-color: #fffff;">
      ...
      <div id="page-wrapper" style="background-color: #ffffff;">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header" style="color: black; font-family: 'Helvetica'; font-size: 50px;">Data Petugas</h1>
          </div>
        </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <footer class="text-center">
      <div class="footer-below" style="background-color:  background:  background: rgb(219,88,0);
