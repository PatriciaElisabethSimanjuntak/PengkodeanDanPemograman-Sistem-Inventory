...
<html>
  ...
  <ul class="nav navbar-top-links navbar-right">
      ...
      <div id="page-wrapper" style="background-color: #ffffff;">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header" style="color: black; font-family: 'Helvetica'; font-size: 50px;">Data Supplier</h1>
          </div>
        </div>
        ...
        <button type="submit" name="simpan" class="btn btn-primary">Save changes</button>
         ...
         <div class="row">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning" style="background-color: #ffffff;">
                                        <thead>
                                            <tr>
